...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CFWpdEB-.mjs");
...
var manifest = {
	"232d6b3ff90385172d5c5bd2465796d35a7aa80f10b2d9082a98bfbd4838d8c5": {
		functionName: "generateScript_createServerFn_handler",
		importer: () => import("./studio-ai-D31dFm9e.mjs")
	},
	"363edf024cb19c6043138ac5f90a948c88693eb191b5929972001fcd8d39630f": {
		functionName: "getAiStatus_createServerFn_handler",
		importer: () => import("./studio-ai-D31dFm9e.mjs")
	},
	"37b761e06913459188d55188d472c912d96b5ef8c31745a576fe3f68d19291df": {
		functionName: "transcribeAudio_createServerFn_handler",
		importer: () => import("./studio-ai-D31dFm9e.mjs")
	},
	"a8eebe88bf826b68aa2c5168edd1bb09c0256a9e3dc7593354785ee6655a516c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BxWpV8Ft.mjs").then((n) => n.t),
