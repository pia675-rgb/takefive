...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BxWpV8Ft.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-sm bg-popover px-2.5 py-1.5 text-xs text-popover-foreground shadow-[var(--shadow-border)] animate-in fade-in-0 zoom-in-95", className),
	...props
}) }));
...
function Toaster$1() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
		...
		toastOptions: { classNames: {
			toast: "bg-card text-foreground border-border shadow-[var(--shadow-border)]",
...
var styles_default = "/assets/styles-COFfkKTi.css";
var APP_NAME = "TAKE FIVE";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "해커톤 시연 영상을 찍고, 대본을 쓰고, 나레이션을 입히는 5분 스튜디오."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter = () => import("./routes-BrKSjzQl.mjs");
